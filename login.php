...
<head>
    ...
    <link rel="shortcut icon" href="imagenes/LogoUabjo.png" type="image/x-icon">
                   ...
                   <br> 
                        ...
                        <form class="form-horizontal" role="form" method="post" action="login/validar.php">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="text" style="text-align: center;" class="form-control" name="usuario" placeholder="Introduce tu nombre o email" required="true">
