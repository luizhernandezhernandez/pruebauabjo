...
FROM  entrega_tareas INNER JOIN estudiantes ON  entrega_tareas.idEstudiante =  estudiantes.idEstudiante 
       ...
       echo '<table class="table table-striped table-condensed table-hover table-responsive">
        	<tr>
                         ...
                         <th width="15%">Código de Docente</th> 
                        <th width="15%">Estudiante</th>
                        <th width="15%">Asignatura</th>
                        <th width="15%">Descripción Tarea</th>
	     ...
	     while($registro2 = mysqli_fetch_array($registro)){
		      echo '<tr>
                          ...
                          <td>'.$registro2['Archivo'].'</td>                 
                           <td> 
                          <a href="../estudiantes/entrega_tareas/pdf/archivo.php?id='.$registro2['id'].'"> <img src="images/verArchivo2.png" width="25" height="25" alt="delete" title="Ver Archivo" /></a>
