...
where entrega_tareas.CodigoTareaDocente = '$dato' LIMIT $limit, $nroLotes ");
  	$tabla = $tabla.'<table class="table table-striped table-condensed table-hover table-responsive">
                       ...
                       <th width="15%">Código Docente</th> 
                        <th width="15%">Asignatura</th>
                        <th width="20%">Descripción Tarea</th>
                        <th width="15%">Código Tarea Enviada</th> 
      ...
      $tabla = $tabla.'<tr>
                          ...
                          <td>'.$registro2['Archivo'].'</td>                 
                           <td> <a href="../estudiantes/entrega_tareas/pdf/archivo.php?id='.$registro2['id'].'"> <img src="../docentes/images/verArchivo2.png" width="25" height="25" alt="delete" title="Ver Archivo" /></a>                                       
                             </td>
                </tr>';	
	}
