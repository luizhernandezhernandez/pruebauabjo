        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
               ...
               <center><h2 style="color:black; font-family: gotic; " >REPORTE DE ESTUDIANTE</h2></center>
       ...
       <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <center><h4><b>Listado de Estudiantes</b></h4></center>
                     ...
                     <th>Asignatura</th>
                      ...
                      <th>Comentarios</th>
                       ...
                       echo "<td colspan='3'>No existen Estudiantes que Mostrar</td>";
                        ...
                        $consulta=mysqli_query($conexion, "SELECT asignaturas.idAsignatura as id, asignaturas.NombreAsignatura as Asignatura, concat(estudiantes.NombresEstudiante,' ' ,estudiantes.ApellidosEstudiante) as Estudiante, inscripciones_asignaturas.fechaInscripcion as Fecha, inscripciones_Asignaturas.observaciones as Observaciones
                 ...
                 <?php
                    echo '<a href="Reporte_Estudiantes_X_Asignaturas.php?id='.$asig.'" target="_blank"> <button class="btn btn-warning" style="float: left; "><i class="fa fa-arrow-left"></i> Exportar Listado a PDF</button> </a> ';
                  ?>
