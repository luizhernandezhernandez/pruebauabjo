        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
               ...
               <center><h2 style="color:black; font-family: gotic; " >EVALUACIONES </h2></center>
             ...
             <div class="col-lg-12">
                    ...
                    <li class="active">Evaluación de Estudiantes</li>
                </ol>
            </div>
        </div> 
        <!-- /.row -->
 ...
 ?>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <center><h4><b>Evaluación de Estudiantes</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
                   ...
                   <div class="col-md-5">
		                  <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escriba el Número de Carnet del Estudiante">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nueva Evaluación</button> 
		                  <a href="reportes/Reporte_Evaluaciones.php"> <button class="btn btn-primary"><i class="fa fa-file-pdf-o"></i>  Exportar a PDF</button> </a>
		               </div>
	              <br>
 <br>
    ...
    <?php
include('../admin/conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM evaluaciones where idDocente = $codigo"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-pencil'></i>&nbsp;&nbsp;Evaluación a los Estudiantes</b></h4>
            </div>
...
<div class="form-group"> <label for="carnet" class="col-md-4 control-label">*Puntaje o calificación:</label>
