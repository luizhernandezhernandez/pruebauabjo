...
where planificacion_tareas.idDocente = '$codigo' ORDER BY planificacion_tareas.idPlanificacion ASC");
    ...
    echo '<table class="table table-striped table-condensed table-hover">
        	 <tr>
                         <th width="10%">Número Asignado</th>  
