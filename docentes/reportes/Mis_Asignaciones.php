...
class PDF extends FPDF
{
		function Header()
		{
			...
			$this->Cell(80);
			$this->Cell(50,20,utf8_decode('Reporte de mis Asignaciones'),0,0,'C');
			$this->Ln(15);
		   ...
		   // $this->Cell(20,20,'Mis Asignaciones:',0,0,'L');
			...
			$this->Cell(35, 8, utf8_decode('Asignación') ,1,0,'C');
			$this->Cell(20, 8, utf8_decode('Número') ,1,0,'C');
			$this->Cell(40, 8, utf8_decode('Asignatura') ,1,0,'C');
			$this->Cell(15, 8, utf8_decode('Grupo') ,1,0,'C');
			$this->Cell(15, 8, utf8_decode('Turno') ,1,0,'C');
			$this->Cell(30, 8, utf8_decode('Horario') ,1,0,'C');
			$this->Cell(20, 8, utf8_decode('Estado') ,1,0,'C');
			$this->Ln(5);
		}
        ...
        $item = 0;
			while($asignaciones2 = mysqli_fetch_array($asignaciones)){
				...
				$pdf->Cell(35, 8, utf8_decode($asignaciones2['Asignacion']), 0);
				$pdf->Cell(20, 8, $asignaciones2['NumeroA'], 0);
				$pdf->Cell(40, 8, utf8_decode($asignaciones2['Asignatura']), 0);
				$pdf->Cell(15, 8, utf8_decode($asignaciones2['Grupo']), 0);
			    $pdf->Cell(15, 8, $asignaciones2['Turno'], 0);
			   	$pdf->Cell(30, 8, $asignaciones2['Horario'], 0);
			   	$pdf->Cell(20, 8, $asignaciones2['Estado'], 0);
				$pdf->Ln(5);
			}
			$pdf->Ln(8);
