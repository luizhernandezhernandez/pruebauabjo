...
class PDF extends FPDF
{
		function Header()
		{
			$this->Image('../imagenes/paulo2.png' , 10 ,10, 40 , 20,'PNG');
		    ...
		    $docente = $_POST['docente'];
            $asignaciones = mysqli_query($conexion, "SELECT concat(NombresDocente, ' ' ,ApellidosDocente) as Docente FROM docentes where idDocente = '$docente'");
