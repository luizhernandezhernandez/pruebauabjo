...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
          ...
          $asignatura=mysqli_query($conexion, $consulta4);
        ?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                 ...
                 <center><h2 style="color:black; font-family: gotic; " >PLANES DE ESTUDIO</h2></center>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administración de Planes de Estudio</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir la descripción o el nombre del plan de estudios">
		               </div>
		               	<div class="col-md-6">
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM plan_estudio"));
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">*Descripción:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="nombre" name="nombre" required maxlength="50"></div>
                     ...
                     <?php 
                        ...
                        <div class="form-group"> <label for="year" class="col-md-2 control-label">*N Asignaturas:</label>
                         <div class="col-md-10">
