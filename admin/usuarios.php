             ...
             // $id = $_POST['id-registro'];
              ...
              $consulta=mysqli_query($conexion, "select Foto from usuarios where NivelUsuario= '1' AND Codigo = $codigo");                 
                while($filas=mysqli_fetch_array($consulta)){
                 ...
                 //$nivel= mysqli_query($conexion, "SELECT NivelUsuario FROM usuarios WHERE idUsuario = 'id-registro'");
        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                ...
                <center><h2 style="color:black; font-family: gotic; " > ADMINISTRADORES </h2>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administración de Administradores del Sistema</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">

                  <div class="col-md-4" ><h5>Si desea agregar un nuevo administrador de clic aquí:</h5></div>
                      <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Administrador</button> 
                      <br><br>
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM usuarios WHERE NivelUsuario='1'"));
    ...
    <div class="modal fade" id="registra-datos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
			   ...
			   <div class="form-group"> <label for="nombre" class="col-md-2 control-label">*Correo:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="nombre" name="nombre" required maxlength="50"></div>
			   </div><br>
			   <div class="form-group"> <label for="pass" class="col-md-2 control-label">*Contraseña:</label>
        ...
        <div class="col-md-10"><input type="text" class="form-control" id="alias" name="alias" maxlength="50"></div>
         </div><br>
       ...
       <select name="nivel" class="form-control">
         <option value="1">Administrador</option>
			   ...
			   <div class="form-group"> <label for="codigo" class="col-md-2 control-label">*Código:</label>
