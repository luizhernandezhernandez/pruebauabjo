     ...
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
          ...
          $carrera=mysqli_query($conexion, $consulta1);
           $consulta2="select idGrupo, NombreGrupo from grupos";
          ...
          $consulta4="select idAñoAcademico, NombreAño from año_academico";
          $año=mysqli_query($conexion, $consulta4);
        ?>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                ...
                <!--<img src="../imagenes/baner.png" class="img-responsive">-->
                  <center><h2 style="color:black; font-family: gotic; " >ASIGNATURAS </h2></center>
