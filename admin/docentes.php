            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
               ...
               <!-- <img src="../imagenes/baner.png" class="img-responsive"> -->
                 <center><h2 style="color:black; font-family: gotic; " >ADMINISTRACIÓN DE DOCENTES </h2></center>
        ...
        <div class="panel-body">
            <div class="row">
		               ...
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el nombre del Docente">
		                  ...
		                  <a href="reportes/Reporte_Docentes.php" target="_blank"> <button class="btn btn-primary"><i class="fa fa-file-pdf-o"></i>  Exportar Listado a PDF</button> </a>
		               </div>
	              <br>
 <br>
    ...
    <div class="modal fade" id="registra-datos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="col-md-10"><input type="text" class="form-control" id="alias" name="alias" maxlength="50"></div>
			   ...
			   <div class="form-group"> <label for="celular" class="col-md-2 control-label">Celular:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="celular" name="celular"maxlength="12"></div>
			   </div><br>
