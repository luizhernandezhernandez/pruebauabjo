        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                  ...
                  <center><h2 style="color:black; font-family: gotic; " >GRUPOS </h2></center>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administración de Grupos</b></h4></center>
        </div>
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM grupos"));
    ...
    <div class="modal fade" id="registra-datos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          ...
          <div class="form-group"> <label for="codigo" class="col-md-2 control-label">*Número Grupo:</label>
