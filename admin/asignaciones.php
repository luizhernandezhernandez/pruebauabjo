...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
          ...
          $consulta3="select idGrupo, NombreGrupo from grupos";
            ...
            <div class="col-md-3"><img src="../imagenes/PAULO2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                ...
                <!--<img src="../imagenes/baner.png" class="img-responsive">-->
                 <center><h2 style="color:black; font-family: gotic; " >ASIGNACIONES </h2></center>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administración de Asignaciones</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
                   ...
                   <div class="col-md-5">
                          <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir la Descripción de la Asignación">
                       </div>
                        <div class="col-md-6">
                          <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nueva Asignación</button> 
                          <a href="reportes/Reporte_Asignaciones.php"target="_blank"> <button class="btn btn-primary"><i class="fa fa-file-pdf-o"></i>  Exportar a PDF</button> </a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Descripción:</label>
                <div class="col-md-10"><input type="text" class="form-control" id="nombre" name="nombre" maxlength="80"></div>
               </div> <br>    
