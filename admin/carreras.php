        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                ...
                <center><h2 style="color:black; font-family: gotic; " >CARRERAS </h2></center>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administración de Carreras</b></h4></center>
        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-th-list'></i>&nbsp;&nbsp;Carreras</b></h4>
            </div>
