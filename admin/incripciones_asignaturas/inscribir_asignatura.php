...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
          ...
          $consulta2="select idAñoAcademico, NombreAño from años_academicos";
          $Año=mysqli_query($conexion,$consulta2);
 ...
 <a href="../inscripcion_asignatura.php"> <button class="btn btn-warning" style="float: left; "><i class="fa fa-arrow-left"></i> Volver al Listado</button> </a> 
        ...
        <div class="panel-body">
          ...
          <div class="form-group"> <label for="carrera" class="col-md-3 control-label">Carrera:</label>
                      ...
                      <?php 
                          while($fila=mysqli_fetch_row($Año)){
                          echo "<option value='".$fila['0']."'>".$fila['1']."</option>";
                          }
                          ?>
                      </select>
                    ...
                    <tr>
                     <th>Codigo</th>
                      ...
                      $consulta=mysqli_query($conexion,"select idAsignatura, NombreAsignatura from asignaturas ORDER BY idAsignatura desc");
                       ...
                       $consulta=mysqli_query($conexion,"select idAsignatura, NombreAsignatura from asignaturas where Idcarrera = '".$_POST['carrera']."' and idAñoAcademico = '".$_POST['Año']."' and idcuatrimestre = '".$_POST['cuatrimestre']."' ORDER BY idAsignatura desc"); 
                    }
