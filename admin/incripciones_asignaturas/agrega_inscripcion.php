...
switch($proceso){
	case 'Registro': mysqli_query($conexion,"INSERT INTO inscripciones_asignaturas (idCarrera,idAsignatura,idEstudiante, fechaInscripcion, observaciones) VALUES('$carrera','$asignatura','$estudiante','$fecha','$observaciones')");
	break;
 ...
 ORDER BY inscripciones_asignaturas.idInscripcion ASC");

    echo '<table class="table table-striped table-condensed table-hover">
        	 <tr>     <th width="15%">Código</th>
