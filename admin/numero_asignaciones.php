...
<head>
    ...
    <title>Numero asignaciones</title>
        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                 ...
                 <center><h2 style="color:black; font-family: gotic; " >ASIGNACIONES A DOCENTES</h2></center>
             ...
             <div class="col-lg-12">
                    ...
                    <li class="active">Asignaciones a Docentes</li>
                </ol>
            </div>
        </div> 
        <!-- /.row -->
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administración de Numeros de Asignación a Docente</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Numero de Asignación">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Numero de Asignación</button>
		               </div>
	              <br>
 <br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-sort-by-order'></i>&nbsp;&nbsp;Numeros de Asignación Docente</b></h4>
            </div>
