        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
                 ...
                 <center><h2 style="color:black; font-family: gotic; " >MIS CALIFICACIONES </h2> </center>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-3"><h4>Buscar Calificación:</h4></div>
		               
                   <div class="col-md-5">
		                  <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escriba el Nombre de la Asignatura">
		               </div>
		               	<div class="col-md-4">
		                  <a href="reportes/Reporte_Calificaciones.php"target="_blank"> <button class="btn btn-success"><i class="fa fa-file-pdf-o"></i>  Exportar a PDF</button> </a>
		               </div>
	              <br>
 <br>
