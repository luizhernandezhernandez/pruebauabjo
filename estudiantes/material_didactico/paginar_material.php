...
$codigo = $_SESSION["Codigo"];
    ...
    $numeroRegistros = mysqli_num_rows(mysqli_query("SELECT * FROM asignaciones"));
    $nroLotes = 10;
...
where material_didactico.CodigoMaterial = '$dato' LIMIT $limit, $nroLotes ");
      ...
      $tabla = $tabla.'<tr>
                          ...
                          <td>'.$registro2['Fecha'].'</td>                 
                           <td> <a href="../docentes/material_didactico/pdf/archivo.php?id='.$registro2['id'].'"> <img src="../docentes/images/verArchivo2.png" width="25" height="25" alt="delete" title="Ver Archivo" /></a>                                       
                             </td>
                </tr>';	
	}
