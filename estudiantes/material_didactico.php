        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/paulo2.png" width="80" height="80" class="img-responsive"></div>
                       <div class="col-md-6">   
                        ...
                        <center><h2 style="color:black; font-family: gotic; " >MATERIALES DE APOYO </h2>  </center>    
        ...
        <div class="panel-body">
            <div class="row">
                  <!--Fin del Segundo Row !-->
                   ...
                   <div class="col-md-5">
		                  <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escriba el Código del Material">
		               </div>
	              <br>
            <br>
            <br>
